...
function resolveDefaultManifestModelIdNormalizationPlugins(): readonly ManifestModelIdNormalizationPlugin[] {
  return (
...
export function normalizeStaticProviderModelId(
  ...
  const manifestPlugins =
    options.manifestPlugins ?? resolveDefaultManifestModelIdNormalizationPlugins();
  const manifestModelId = normalizeProviderModelIdWithManifestPlugins({
